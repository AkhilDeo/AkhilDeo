...
I conduct research in medical robotics with the <a href="https://lcsr.jhu.edu/" target="_blank">JHU Laboratory for Computation Sensing and Robotics</a>. My current project entails improving the pre-operative protocols for conducting the Nuss Procedure using augmented reality. My previous project was a nifty phone app that could teleoperate a da Vinci Research Kit. See <a href="https://doi.org/10.31256/HSMR2023.63" target="_blank">my poster</a> in the Hamlyn Symposium on Medical Robotics for more info. 
